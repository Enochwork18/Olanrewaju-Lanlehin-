...
export default function About() {
  ...
  return (
    <section id="about" ref={sectionRef} className="relative px-4 md:px-8 lg:px-16 xl:px-24 py-16 md:py-24">
      <DecorativeAccents />
        ...
        <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
          ...
          >
            <div className="relative w-full aspect-[3/4] max-w-sm mx-auto md:mx-0">
              <div className="absolute inset-0 border-2 border-crimson rounded-2xl translate-x-2 translate-y-2" />
              <Image
